...
PVAL     p_value
OUTFILE  ../../data/processed_data/meta-analysis/meta-analysis_results/ALL_META_ANALYSIS .tsv
...
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/fischer_et_al_prefrontal_cortex_ad_vs_control.csv
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/king_et_al_BA17_visual_cortex_synaptoneurosome_ad_vs_ha.tsv
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/king_et_al_BA17_visual_cortex_total_brain_homogenate_ad_vs_ha.tsv
...
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/miller_et_al_hippocampus_ad_vs_control_RIN_corrected_processed.tsv
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/miller_et_al_parietal_cortex_ad_vs_control_RIN_corrected_processed.tsv
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/miller_et_al_parietal_white_matter_ad_vs_control_RIN_corrected_processed.tsv
...
PROCESSFILE ../../data/processed_data/meta-analysis/meta-analysis_input/van_rooij_et_al_hippocampus_ad_vs_control.tsv
